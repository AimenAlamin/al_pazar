...
class ColorsManager {
  static const Color mainBlue = Color.fromARGB(229, 236, 21, 21);
  static const Color whiteColors = Color.fromARGB(255, 255, 255, 255);
  ...
  static const Color darklight = Color.fromARGB(136, 43, 42, 42);
